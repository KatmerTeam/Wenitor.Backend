...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Katmer.Wenitor.Alert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("TargetSourceId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Katmer.Wenitor.ScheduleCheck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppScheduleChecks");
                });

            modelBuilder.Entity("Katmer.Wenitor.TargetSelector", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppTargetSelectors");
                });

            modelBuilder.Entity("Katmer.Wenitor.TargetSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ScheduleCheckId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ScheduleCheckId");

                    b.ToTable("AppTargetSources");
                });
            ...
            modelBuilder.Entity("Katmer.Wenitor.Alert", b =>
                {
                    b.HasOne("Katmer.Wenitor.TargetSource", null)
                        .WithMany("Alerts")
            ...
            modelBuilder.Entity("Katmer.Wenitor.TargetSelector", b =>
                {
                    b.HasOne("Katmer.Wenitor.TargetSource", null)
                        .WithMany("TargetSelectors")
                        .HasForeignKey("TargetSourceId");
                });

            modelBuilder.Entity("Katmer.Wenitor.TargetSource", b =>
                {
                    b.HasOne("Katmer.Wenitor.ScheduleCheck", "ScheduleCheck")
                        .WithMany()
                        .HasForeignKey("ScheduleCheckId");
                });
